            ...
            <section className="w-9/10 mx-auto relative mt-40 mb-10">
                ...
                <div className="grid grid-cols-3 gap-5 w-3/4 my-2">
                    <div>
                        ...
                        <p className="text-secondary-700">{allMeetings[id].date}</p>
                    </div>
                    <div>
                        <h1 className="text-2xl text-secondary-700">Time</h1>
                        <p className="text-secondary-700">{allMeetings[id].time}</p>
                    </div>
                    <div>
                        <h1 className="text-2xl text-secondary-700">Venue</h1>
                        <p className="text-secondary-700">{allMeetings[id].venue}</p>
                    </div>
                    <div>
                        <h1 className="text-2xl text-secondary-700">Organizer</h1>
                        <p className="text-secondary-700">{allMeetings[id].organizer}</p>
                    </div>
                    <div>
                        <h1 className="text-2xl text-secondary-700">Mode </h1>
                        <p className="text-secondary-700">{allMeetings[id].join}</p>
                    </div>
                </div>

                <h1 className="text-3xl text-secondary-800 mt-8">Summary</h1>
                <p className="text-secondary-700 w-3/4">{allMeetings[id].summary}</p>
                ...
                <div className="flex item-center column my-2">
                    <img
                        ...
                        alt="PDF"
                    />
                    <p className="text-secondary-700 pl-2">Subject Of Discussion.pdf</p>
                </div>
                <div className="flex item-center column my-2">
                    <img
