...
const Meets = (props) => {
    ...
    const [showNumberOfDataImportant, setShowNumberOfDataImportant] =
        useState(4);
    ...
    return (
        <>
            ...
            <section className='w-9/10 mx-auto relative mt-28 mb-10'>
                ...
                <Table
                    showNumberOfData={showNumberOfDataImportant}
                    updateShowViewMore={setShowViewMoreImportant}
                    data={importantMeetings}
                    numberOfColumns={5}
                />
                {showViewMoreImportant && (
                    <p
                        className='relative text-right pr-6'
                        onClick={updateShowNumberOfDataImportant}>
                        <MyLink text={"View More"} />
                    </p>
                )}
                ...
                <Table
                    showNumberOfData={showNumberOfDataAll}
                    updateShowViewMore={setShowViewMoreAll}
                    data={allMeetings}
                    numberOfColumns={5}
                />
                {showViewMoreAll && (
                    <p
                        className='relative text-right pr-6'
                        onClick={updateShowNumberOfDataAll}>
                        <MyLink text={"View More"} />
                    </p>
                )}
            </section>
