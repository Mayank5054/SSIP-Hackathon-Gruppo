                ...
                {props.isLoggedIn && (
                    <div className=' w-2/5 h-20 pl-4 rounded-bl-full bg-secondary-900 text-primary-900 text-sm font-medium underline decoration-2 shadow-mine flex justify-between items-center'>
                        <div
                            ...
                            <img
                                className='mx-auto'
                                src='https://img.icons8.com/material-outlined/44/440F0F/home--v2.png'
                                alt='home'
                            />
                        ...
                        <div
                            ...
                            <img
                                className='mx-auto'
                                src='https://img.icons8.com/ios-glyphs/44/440F0F/meeting-room.png'
                                alt='meet'
                            />
                        ...
                        <div
                            ...
                            <img
                                className='mx-auto'
                                src='https://img.icons8.com/external-creatype-outline-colourcreatype/44/440F0F/external-history-video-player-line-set-creatype-outline-colourcreatype.png'
                                alt='history'
                            />
                        ...
                        <div
                            ...
                            <img
                                className='mx-auto'
                                src='https://img.icons8.com/ios-glyphs/44/440F0F/system-task--v1.png'
                                alt='DashBoard'
                            />
